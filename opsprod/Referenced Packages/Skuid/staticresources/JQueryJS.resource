...
// NOTE: We applied an unreleased fix from Migrate 3.2 that busted IE9 when the dev console was opened.
// The commit is available at https://github.com/dmethvin/jquery-migrate/commit/d551dce4c77d910b9f11442b18476827d9e9c22f?diff=split
...
/**
 * @author Skuid 
 * Mute console log warnings about deprecated features, etc.
 */
...
( function() {
	...
	/**
	 * @author Skuid 
	 * An unreleased fix from Migrate 3.2 that busted IE9 when the dev console was opened.
	 * The commit is available at https://github.com/dmethvin/jquery-migrate/commit/d551dce4c77d910b9f11442b18476827d9e9c22f?diff=split
	 */
...
$.each( { show: "fadeIn", hide: "fadeOut" }, function( method, defaultEffect ) {
	$.Widget.prototype[ "_" + method ] = function( element, options, callback ) {
		...
		/**
		 * @author Skuid
		 * Necessary to work in Strict Mode
		 */
		if ( options === true ) {
